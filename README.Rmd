...
Prediction is parallelized. By default, every available core is used. `tidydann_set_threads()` changes the count for dann alone, which is useful when resamples are already being fit in parallel.
